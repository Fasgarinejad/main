    ...
    <div class="container">
        ...
        <div class="column right-column">
            ...
            <ul>
                ...
                Average recommendation across 10 quarters as teaching assistant: <strong>90.6%</strong><br>
           ...
           <li><strong>Teaching Assistant, Halıcıoğlu Data Science Institute</strong>
            ...
            <ul>
                <li><strong>Teaching Assistant:</strong> DSE 220x - Machine Learning Fundamentals (Prof. Sanjoy Dasgupta, Three Semesters Sep 2019- Sep 2020)</li>
            </ul>
